        ...
        <div class="layout">
            <div class="banner">
                <div class="banner-positioning">
                    ...
                    <div class="photo">
                        <img :src="`${$config.imageURL}/promotion/`+gambar" alt="">
                    </div>
            ...
            <div class="content">
                ...
                <div class="main_content">
                    ...
                    <div class="deskripsi">
                        ...
                        <div v-html="deskripsi" style="padding-top:10px;"></div>
                    </div>                   
                </div>
            </div>
...
export default {
    ...
    mounted(){
      ...
      this.$axios.get(`/api/web/promotions/${this.$route.params.slug}`)
        ...
        .then(response => {
          ...
          this.deskripsi = response.data.data.description
